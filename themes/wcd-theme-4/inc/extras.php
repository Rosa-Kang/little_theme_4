 ...
 * @return array
 */
function wcd_body_classes( $classes ) {
...
add_filter( 'body_class', 'wcd_body_classes' );
 ...
 * */ 
function wcd_new_excerpt_more($more) {
  return '...';
}
add_filter('excerpt_more', 'wcd_new_excerpt_more', 21 );
 ...
 * 
 * */ 
function wcd_numeric_posts_nav() {
  if( is_singular() )
      return;
